...
### TYPE YOUR CODE BELOW ###
Q5 <- diff(range(apdata$wGPA, na.rm = T))
...
Q10 <- (3.84 - mean(apdata$wGPA, na.rm = T)) / sd(apdata$wGPA, na.rm = T)
...
a <- quantile(apdata$wGPA, .25, na.rm = T)
b <- quantile(apdata$wGPA, .50, na.rm = T)
c <- quantile(apdata$wGPA, .75, na.rm = T)
Q11 <- c(a, b, c)
### VIEW OUTPUT ###
Q11
