...
### TYPE YOUR CODE BELOW ###
Q6A <- boxplot(apdata$PSAT, horizontal = TRUE, xlab="PSAT Score")
...
### TYPE YOUR CODE BELOW ###
Q8A <- hist(apdata$PSAT, xlab = "PSAT Scores", main = "PSAT Scores")
...
### TYPE YOUR CODE BELOW ###
#predict(apdata_clean)
Q16 <- predict(mod1, newdata=apdata_clean[1, ])
### VIEW OUTPUT ###
Q16
...
Q17 <- summary(lm(apdata_clean$ACTUAL~apdata_clean$PSAT))
#summary(mod1)
### VIEW OUTPUT ###
Q17[c(6,8)]
...
### TYPE YOUR CODE BELOW ###
Q18 <- cor(apdata_clean$ACTUAL,apdata_clean$PSAT, use = "everything")
