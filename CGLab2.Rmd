...
For CodeGrade purposes, you must comment out any package installation code prior to submitting your assignment (ie: #install.packages("package_name")) **Important**: Do not install any other packages for this lab. Use only base R (built-in) functions.
